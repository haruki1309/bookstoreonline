                ...
                <div class="tab-menu">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#sale" aria-controls="sale" role="tab" data-toggle="tab">Sách bán chạy nhất</a>
                        </li>
                    </ul>
                </div>         
            </div>
                        ...
                        <div class="single-p-banner">
                                ...
                                <div class="single-banner">
                                    <div class="product-wrapper">
                                        <a href="#" class="single-banner-image-wrapper">
                                            <img alt="" src="{{url('asset/img/featured/2.jpg')}}">
                                            <div class="price"><span>$</span>160</div>
                                            <div class="rating-icon">
                            ...
                            <div class="col-md-3">
                                <div class="single-banner">
                                    <div class="product-wrapper">
                                        <a href="#" class="single-banner-image-wrapper">
                                            <img alt="" src="{{url('asset/img/featured/6.jpg')}}">
                                            <div class="price"><span>$</span>160</div>
                                            <div class="rating-icon">
                                                <i class="fa fa-star icolor"></i>
                                                <i class="fa fa-star icolor"></i>
            ...
            <div class="col-md-12">
                <div class="testimonial-list">
                    <div class="single-testimonial">
                       <img src="{{url('asset/img/testimonial/1.jpg')}}" alt="">
                    ...
                    <div class="single-testimonial">
                       <img src="{{url('asset/img/testimonial/2.jpg')}}" alt="">
                       <div class="testmonial-info clearfix">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation. </p> 
                           <div class="testimonial-author text-center">
                               <h3>Ashim Kumar</h3>
